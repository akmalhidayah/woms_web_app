                        ...
                        <tr class="transition hover:bg-[#fffaf6]">
                                    ...
                                    <template x-if="t === '2'">
                                        <div class="flex items-center gap-1.5">
                                                @if (! empty($row['lpj_url_termin2']))
                                                    <a href="{{ $row['lpj_url_termin2'] }}" target="_blank" rel="noopener noreferrer" title="LPJ Termin 2" aria-label="LPJ Termin 2" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500 text-white shadow-sm">
                                                        <i data-lucide="file-text" class="h-3.5 w-3.5"></i>
                                                    </a>
                                                @else
                                                    <span title="LPJ Termin 2 belum tersedia" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-300 ring-1 ring-slate-200">
                                                        <i data-lucide="file-text" class="h-3.5 w-3.5"></i>
                                                    </span>
                                                @endif

                                                @if (! empty($row['ppl_url_termin2']))
                                                    <a href="{{ $row['ppl_url_termin2'] }}" target="_blank" rel="noopener noreferrer" title="PPL Termin 2" aria-label="PPL Termin 2" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-orange-500 text-white shadow-sm">
                                                        <i data-lucide="file-spreadsheet" class="h-3.5 w-3.5"></i>
                                                    </a>
                                                @else
                                                    <span title="PPL Termin 2 belum tersedia" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-300 ring-1 ring-slate-200">
                                                        <i data-lucide="file-spreadsheet" class="h-3.5 w-3.5"></i>
                                                    </span>
                                                @endif
                                        </div>
                            ...
                            <td class="px-3 py-3 align-top text-center">
                                <div>
                                    ...
                                    <div class="mt-1.5 text-[9px]">
                                        @if (($row['paid_percent'] ?? 0) > 0)
                                            <span class="inline-flex rounded-full bg-emerald-50 px-2 py-0.5 font-semibold text-emerald-700 ring-1 ring-emerald-200">
                                                {{ $row['paid_percent'] }}%
                                            </span>
                                        @else
                            ...
                            <td class="px-3 py-3 align-top text-center">
                                ...
                                <div class="text-[10px]">
                                    ...
                                    <div class="mt-0.5 text-[9px] text-slate-400">{{ $endStr ?: '-' }}</div>
                                    <div class="mt-1.5">
                                        @if ($endStr)
