<x-layouts.admin title="Laporan Harian">
    <div
        ...
        x-data="{
            ...
            openPhoto(thumbnailUrl, previewUrl, title, date, pic) {
    ...
    >
        ...
        <section class="hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm lg:block" aria-label="Filter Laporan Harian">
        ...
        <section class="lg:overflow-hidden lg:rounded-2xl lg:border lg:border-slate-200 lg:bg-white lg:shadow-sm">
            ...
            @if ($rows->hasPages())
                <div class="mt-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm lg:mt-0 lg:rounded-none lg:border-x-0 lg:border-b-0 lg:bg-slate-50/40 lg:shadow-none">{{ $rows->links() }}</div>
            @endif
        </section>
