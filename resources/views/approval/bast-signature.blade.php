                                ...
                                <div class="space-y-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="mt-1 break-words text-sm font-bold text-slate-900">{{ $lhpp?->nomor_order ?: '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div class="mt-1 break-words text-sm font-bold text-slate-900">{{ $lhpp?->notifikasi ?: '-' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rounded-2xl border border-slate-200 bg-white px-4 py-4 lg:col-span-2 xl:col-span-2">
                                ...
                                <div class="mt-3 flex flex-wrap gap-2 text-[11px] font-semibold">
                                    <span class="inline-flex max-w-full items-center gap-1.5 rounded-full bg-orange-50 px-2.5 py-1 text-orange-700 ring-1 ring-orange-100">
                                        ...
                                        <span class="min-w-0 break-words">Unit: {{ $lhpp?->unit_kerja ?: '-' }}</span>
                                    </span>
                                    <span class="inline-flex max-w-full items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-slate-600 ring-1 ring-slate-200">
                                        ...
                                        <span class="min-w-0 break-words">Seksi: {{ $lhpp?->seksi ?: '-' }}</span>
                                    </span>
                                </div>
                            </div>
                                            ...
                                            <div id="signaturePadShell" class="relative mt-4 overflow-hidden rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 p-3 transition">
                                                <div class="absolute right-3 top-3 z-20 flex flex-wrap justify-end gap-2">
                                                    @if ($canSign && !empty($recentSignatureDataUrl ?? null))
                                                        <button type="button" id="useRecentSignature" data-signature-src="{{ $recentSignatureDataUrl }}" class="rounded-full border border-[#e2b39a] bg-white/95 px-3 py-1.5 text-[11px] font-semibold text-[#b85b2b] shadow-sm transition hover:bg-orange-50">
                                                            Pakai TTD Terakhir
                                                        </button>
                                                    @endif
