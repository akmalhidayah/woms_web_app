...
class DashboardAdditionalGridUiTest extends TestCase
{
    ...
    public function test_dashboard_displays_overhaul_prognosis_and_top_ten_cost_grids(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('data-dataset-key="general"', false)
            ->assertSee('data-dataset-key="maintenance"', false)
            ->assertSee('data-dataset-key="non_maintenance"', false)
            ->assertSee('data-dataset-key="capex"', false)
