@php
    ...
    $workshopKpis = [
        ...
        ['label' => 'Belum Selesai', 'value' => number_format($workshopSummary['incomplete'], 0, ',', '.'), 'cardClass' => 'border-b border-white/30 bg-indigo-700 text-white xl:border-b-0 xl:border-r', 'accentClass' => 'border-indigo-300 text-indigo-100', 'valueClass' => 'text-white'],
        ['label' => 'Order Dijasakan', 'value' => number_format($workshopSummary['outsourced'], 0, ',', '.'), 'cardClass' => 'bg-sky-700 text-white', 'accentClass' => 'border-sky-300 text-sky-100', 'valueClass' => 'text-white'],
    ];
@endphp
...
<section class="rounded-xl bg-blue-100 px-3 py-2.5">
    ...
    <div class="grid overflow-hidden sm:grid-cols-2 xl:grid-cols-5">
