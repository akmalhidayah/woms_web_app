...
>
    <div
        ...
        class="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-white/15 bg-white shadow-2xl"
    >
        ...
        <div class="flex min-h-0 flex-1 items-center justify-center bg-slate-100 p-3 sm:p-5">
            <img
                ...
                class="max-h-[calc(92vh-7rem)] max-w-full rounded-xl bg-white object-contain shadow-sm"
            >
        </div>
    </div>
</div>
