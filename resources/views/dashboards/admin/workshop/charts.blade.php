    ...
    <article class="min-w-0 overflow-hidden rounded-xl border border-slate-200 bg-white p-4 shadow-sm lg:col-span-2">
        <div class="flex items-center gap-2 border-b border-slate-100 pb-3">
            ...
            <div>
                ...
                <p class="mt-0.5 text-[10px] text-slate-500">Selesai berdasarkan Serah Terima completed</p>
            </div>
        </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-3">
        <div class="flex items-center gap-2">
            ...
            <div>
                ...
                <p class="mt-0.5 text-[10px] text-slate-500">Kumulatif berdasarkan tanggal order dan tanda tangan Serah Terima</p>
            </div>
        </div>
